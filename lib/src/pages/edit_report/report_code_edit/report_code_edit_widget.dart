...
import 'report_code_edit_model.dart';
export 'report_code_edit_model.dart';

class ReportCodeEditWidget extends StatefulWidget {
  /// #595D62
  const ReportCodeEditWidget({super.key});

  @override
  State<ReportCodeEditWidget> createState() => _ReportCodeEditWidgetState();
}

class _ReportCodeEditWidgetState extends State<ReportCodeEditWidget> {
  late ReportCodeEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportCodeEditModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.reportDoc =
          await ReportRecord.getDocumentOnce(FFAppState().updatedReportDoc!);
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    await Clipboard.setData(ClipboardData(
                                        text: _model.reportDoc!.reportCode));
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        FFAppState().updatedReportDoc = null;
